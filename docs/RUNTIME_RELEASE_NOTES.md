...
The asset contains only fixed resources: ffmpeg, XeSS/XeFG/XeLL binaries, the portable Python/OpenVINO environment, depth/SEA-RAFT models, and XeSS 2.1 developer headers/import libraries. Frequently updated node and pipeline sources stay in Git.
