...
class ResNetFPN(nn.Module):
    ...
    def _init_weights(self, args):
        ...
        # The portable SR package ships a merged, self-contained state dict.
        # Keep the upstream ImageNet initialization path for development, but
        # allow offline runtimes to skip torchvision and network downloads.
        if self.init_weight and getattr(args, "pretrained_init", True):
